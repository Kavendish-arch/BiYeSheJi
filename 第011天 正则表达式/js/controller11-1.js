...
console.log("GMT 格林尼治时间 ",d1.toUTCString());
console.log("UTC协调世界时间 ",d1.toGMTString());
...
// 7. 设定月 0 ~ 11（记得加1）
console.log("设定月 0 ~ 11（记得加1）",d1.getMonth() + 1);
// 8. 设定日（是几就是几）
console.log("设定日",d1.getDate());
...
// 11. Date 克隆
var d4 = new Date(d1);
console.log("data copy",d1,'\n', d4);

// 12. 比较
var d5 = new Date(2018,0,1);
var d6 = new Date(2017,0,1);
console.log("data compare ",(d5 - d6)/(1000 * 3600 * 24));
